...
-- Provider Doctor observability tables (mirrors migrations/0011_provider_doctor_observability.sql)
-- for fresh installs. Safe metadata/evidence only — never provider credentials or raw request bodies.
