...
export const KNOWN_PROVIDER_TEMPLATES: readonly KnownProviderTemplate[] = [
	...
	{ id: "google-relay", displayName: "Google via Relay", providerSlug: "google-relay", transport: "gateway-custom", authType: "byok", allowedAuthTypes: ["byok", "none"], credentialRequired: true, apiPath: "v1/chat/completions", testModel: "gemini-3.6-flash", description: "Opt-in HTTPS OpenAI-compatible relay for Gemini traffic through a Cloudflare AI Gateway Custom Provider. Native Google AI Studio remains separate; aliases are never retargeted automatically.", customizable: true },
